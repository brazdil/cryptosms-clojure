...
(with-test
  ...
  (is (= (sha1
           (ASCII8 "Hi There")
           (byte-arrays/from-vector (HEX "0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b")))
         (HEX "b617318655057264e28bc0b6fb378c8ef146be00")))
  (is (= (sha1
           (ASCII8 "what do ya want for nothing?")
           (byte-arrays/from-vector (ASCII8 "Jefe")))
         (HEX "effcdf6ae5eb2fa2d27416d5f184df9c259a7c79")))
  (is (= (sha1
           (vec (repeat 50 0xdd))
           (byte-arrays/from-vector (HEX "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")))
         (HEX "125d7342b9ac11cd91a39af48aa17b4f63f175d3")))
  (is (= (sha1
           (vec (repeat 50 0xcd))
           (byte-arrays/from-vector (HEX "0102030405060708090a0b0c0d0e0f10111213141516171819")))
         (HEX "4c9007f4026250c6bc8414f9bf50c86c2d7235da")))
  (is (= (sha1
           (ASCII8 "Test With Truncation")
           (byte-arrays/from-vector (HEX "0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c")))
         (HEX "4c1a03424b55e07fe7f27be1d58bb9324a9a5a04")))
  (is (= (sha1
           (ASCII8 "Test Using Larger Than Block-Size Key - Hash Key First")
           (byte-arrays/from-vector (vec (repeat 80 0xaa))))
...
(with-test
  ...
  (is (= (sha256 
           ...
           (byte-arrays/from-vector (HEX "4a656665"))) 
  ...
  (is (= (subvec (sha256 
                   ...
                   (byte-arrays/from-vector (HEX "0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c"))) 0 16) 
  ...
  (is (= (sha256 
           ...
           (byte-arrays/from-vector (HEX "")))
